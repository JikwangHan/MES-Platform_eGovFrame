...
## PR-18 증빙 요약(2026-01-17)
### 코드 변경 증빙
- 변경 파일:
  - ai-middleware/README.md
  - scripts/run_crypto_smoke.ps1
- 변경 요약: CryptoService 설정/스모크 가이드와 자동 실행 스크립트 추가
- 영향 범위: 문서/스크립트(로직 변경 없음)

### 스모크/테스트 증빙
- 실행 방법: `scripts/run_crypto_smoke.ps1`
- 결과: 운영 환경에서 동일 절차 실행 후 기록 예정

### 문서 증빙
- 변경 문서 목록: 위 “변경 파일”과 동일
- 핵심 변경점 3줄 요약:
  - CryptoService 설정 키를 README에 명시
  - 암호화 스모크 실행을 스크립트로 일괄화
  - 운영 전 점검 절차를 한 번에 수행 가능
