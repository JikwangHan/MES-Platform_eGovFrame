...
public class EquipmentServiceImpl implements EquipmentService {
    ...
    /**
     * 목적: 설비를 등록한다.
     * 기능: DAO를 통해 설비 정보를 저장한다.
     * 이유: 등록 기능을 제공하기 위함이다.
     * 유지보수: 검증 규칙이 추가되면 여기서 처리한다.
     */
    @Override
    public int createEquipment(Map<String, Object> equipment) {
        return equipmentDao.insertEquipment(equipment);
    }

    /**
     * 목적: 설비를 수정한다.
     * 기능: DAO를 통해 설비 정보를 갱신한다.
     * 이유: 수정 기능을 제공하기 위함이다.
    ...
    public int deleteEquipment(String equipmentCode) {
        return equipmentDao.deleteEquipment(equipmentCode);
    }
}
