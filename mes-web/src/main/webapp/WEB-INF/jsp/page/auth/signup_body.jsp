  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>본 약관은 MES 서비스 이용과 관련된 기본 권리/의무 및 책임 사항을 안내합니다.</p>
        <ul>
          <li>회원은 정확한 정보를 등록하고, 서비스 이용 목적에 맞게 계정을 사용합니다.</li>
          <li>타인의 계정을 도용하거나 불법 행위를 하지 않습니다.</li>
          <li>운영 정책과 관련 법령을 준수하며, 위반 시 이용이 제한될 수 있습니다.</li>
          <li>서비스 정책은 사전 공지 후 변경될 수 있습니다.</li>
        </ul>
        <p>상세 약관 전문은 운영 정책 확정 후 제공됩니다.</p>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <ul>
          ...
          <li>이용 목적: 회원 식별, 서비스 제공, 보안 관리</li>
          <li>보관 기간: 서비스 이용 기간 및 관련 법령에 따름</li>
          <li>보안: 암호화 저장 및 접근 통제</li>
        </ul>
        <p>상세 방침 전문은 운영 정책 확정 후 제공됩니다.</p>
      </div>
    </div>
  </div>
</div>
