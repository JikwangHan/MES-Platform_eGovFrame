 ...
 * 유지보수: 복잡한 TSV 규칙이 필요하면 파서를 교체합니다.
 */
public class TsvNormalizer implements Normalizer {
    /**
     * 목적: TSV payload를 표준 Map 구조로 변환합니다.
     * 기능: Base64 복원 후 TSV 파싱과 messageType 추출을 수행합니다.
     * 이유: 분류/검증 단계가 동일한 구조를 요구하기 때문입니다.
     * 유지보수: TSV 파싱 규칙 변경 시 이 메서드를 수정합니다.
     */
    @Override
     ...
     * 기능: 탭 구분된 key=value 쌍을 Map에 저장합니다.
